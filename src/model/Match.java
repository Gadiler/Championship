...
public class Match {
	...
	private HBox hbPenalties1 = new HBox();
	private HBox hbPenalties2 = new HBox();
	private VBox vbPenalties = new VBox();
	...
	public Match(String team1, String team2, String selectedToggle) {
		this.team1 = team1;
		this.team2 = team2;
...
//		for Basketball and Tennis if there's a tie -> extra time.
		...
		if (sumScore().equals("Tie") && selectedToggle.equals("Soccer")) {
			if (allScoreTeam1.get(TieBreaker).getText().isBlank() && allScoreTeam2.get(TieBreaker).getText().isBlank()) {
				...
				hbPenalties1.setSpacing(10);
				hbPenalties1.setAlignment(Pos.CENTER);
				hbPenalties2.setSpacing(10);
				hbPenalties2.setAlignment(Pos.CENTER);
				vbPenalties.setSpacing(10);
				vbPenalties.setAlignment(Pos.CENTER);
				hbPenalties1.getChildren().add(lblTeam1);
				hbPenalties2.getChildren().add(lblTeam2);
				...
				for (int i = 0; i < numOfPenalties; i++) {
					...
					hbPenalties1.getChildren().add(allPenaltiesTeam1.get(i));
					hbPenalties2.getChildren().add(allPenaltiesTeam2.get(i));
				}
				vbPenalties.getChildren().addAll(hbPenalties1, hbPenalties2, btDone);
				gpRoot2.getChildren().add(vbPenalties);
